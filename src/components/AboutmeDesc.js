...
function AboutmeDesc() {
  return (
         <div className='text-content'>
          <p> I’m Ameen Abdulrasheed (yes, the surname has its own charm 😉). Split between Lagos and Ilorin ,Nigeria , I’m here to build meaningful connections as life’s "playtime" evolves into deeper chapters.</p>
