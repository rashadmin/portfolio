  ...
  return (
         <div className='text-content'>
          ...
          <p> I turn data into stories and solutions as a Data Scientist & Engineer (in view). By day, I code in Python/SQL, analyze trends, and engineer software (Flask, React, JS). By night? I’m probably geeking out over anime, tweaking my 
              <a href='https://py-blog-two.vercel.app' style="background-color: #0d6efd; color: white; padding: 2px 6px; border-radius: 6px; text-decoration: none; transition: all 0.3s ease; box-shadow: 0 2px 6px rgba(13, 110, 253, 0.4);">blog </a>, or taking midnight strolls under a cozy weather
          </p>
